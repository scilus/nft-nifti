...
//    public int sizeof_hdr;
    ...
    private static Nifti1Header readMain(DataInput di, Nifti1Header ds) throws IOException
    {
        ...
        {
            int start_addr = Nifti1Header.ANZ_HDR_SIZE;
    ...
    public String toString() {
        return "Nifti1Header{" +
                ...
                ", phase_dim=" + phase_dim +
                ", slice_dim=" + slice_dim +
                ", xyz_unit_code=" + xyz_unit_code +
                ", t_unit_code=" + t_unit_code +
                ", qfac=" + qfac +
                ...
                ", intent=" + Arrays.toString(intent) +
                ", intent_code=" + intent_code +
                ", datatype=" + datatype +
                ", bitpix=" + bitpix +
                ", slice_start=" + slice_start +
                ", pixdim=" + Arrays.toString(pixdim) +
                ...
                ", quatern=" + Arrays.toString(quatern) +
                ", qoffset=" + Arrays.toString(qoffset) +
                ", srow_x=" + Arrays.toString(srow_x) +
                ", srow_y=" + Arrays.toString(srow_y) +
                ", srow_z=" + Arrays.toString(srow_z) +
